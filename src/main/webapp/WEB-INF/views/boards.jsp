...
<script>
    app.controller("angController", function ($scope, $http, $filter) {
        ...
        $scope.loadMainData = function () {
            ...
            ajaxCall($http, "boards/get-boards", null, getMainData);
        }
        ...
        $scope.remove = function (id) {
            if (confirm("დარწმუნებული ხართ რომ გსურთ წაშლა?")) {
                if (id != undefined) {
                    ...
                    ajaxCall($http, "boards/delete-board?id=" + id, null, resFnc);
                }
            }
        };
        ...
        $scope.edit = function (id) {
            if (id != undefined) {
                var selected = $filter('filter')($scope.list, {boardId: id}, true);
        ...
        $scope.save = function () {
            ...
            ajaxCall($http, "boards/save-board", angular.toJson({
                id: $scope.request.boardId,
                ...
                <div class="row">
                    <form class="form-horizontal" name="myForm">
                        <div class="form-group col-sm-10 ">
                            <label class="control-label col-sm-3">კოლეგიის დასახელება</label>
                            <div class="col-sm-9">
                    ...
                    <tr ng-repeat="r in list">
                        ...
                        <c:if test="<%= isAdmin %>">
                            <td class="text-center">
                                <a ng-click="edit(r.boardId)" data-toggle="modal" data-target="#editModal"
                                   class="btn btn-xs">
                                    <i class="fa fa-pencil"></i>&nbsp;შეცვლა
                                </a>&nbsp;|&nbsp;
                                <a ng-click="remove(r.boardId)" class="btn btn-xs">
