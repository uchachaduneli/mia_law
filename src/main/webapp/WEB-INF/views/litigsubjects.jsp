            ...
            if(keycloak.idTokenParsed == null || keycloak.idTokenParsed == undefined || keycloak.idTokenParsed.preferred_username == null || keycloak.idTokenParsed.preferred_username == undefined){
    	        setTimeout(function () {
        	        $scope.$apply(function(){
                        ajaxCallWithHeaders($http, "litigationsubjects/get-litigationsubjects", null, getMainData,null, keycloak.idTokenParsed.preferred_username,keycloak.resourceAccess['justice-service'].roles,keycloak.idTokenParsed.name);
        	        });
        	    }, 1000);
            }else{
    	        ajaxCallWithHeaders($http, "litigationsubjects/get-litigationsubjects", null, getMainData,null, keycloak.idTokenParsed.preferred_username,keycloak.resourceAccess['justice-service'].roles,keycloak.idTokenParsed.name);
            ...
            <div class="box-body">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th>სახელი</th>
                        <c:if test="<%= isAdmin %>">
                            <th class="col-md-3 text-center">მოქმედება</th>
                        </c:if>
                    </tr>
                    </thead>
                    <tbody>
